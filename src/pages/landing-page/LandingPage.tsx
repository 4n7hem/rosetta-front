...
export default function LandingPage() {
  ...
  const handleLogin = () => {
    ...
    fetch("http://localhost:3000/autenticator",{ method: "POST", body: JSON.stringify(body), headers: { "Content-Type": "application/json"} })
    .then( response => response.text())
    .then( response => {
      console.log(response)
      if( response === "Usuário e/ou senha incorretos!" ) return alert("Usuário ou Senha Incorretos")
